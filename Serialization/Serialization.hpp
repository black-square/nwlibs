...
/*
   ...
   [Правило 2: Начало]
      ...
      //Константность входящих параметров заккоментирована для того чтобы не объявлять в классе T
      //функцию Serialize константной (что повлечёт за собой либо const_cast, либо mutable всем 
      //экспортящимся параметрам, либо две версии Serialize константную и неконстантную) 
