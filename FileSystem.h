...
class CDirectoryFileList
{
   ...
   struct SDirItem //Информация о каталоге
   {
      ...
      SDirItem(): Handle(INVALID_HANDLE_VALUE) {}
   };
...
public:
   CUnicodeFileReader(): m_hFile(INVALID_HANDLE_VALUE), m_pBuffBegin(0), m_pBuffEnd(0), m_IsEof(false) {} 
...
// OStream необходимо открывать в бинарном режиме (std::ios::binary)
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Прочитать строку Str из ANSI файла c именем FileName
// Возвр - ERROR_SUCCESS - удачное завершение или значение от GetLastError в случие неудачи
///////////////////////////////////////////////////////////////////////////////
DWORD ReadAnsiFile( const std::basic_string<TCHAR> &FileName, std::basic_string<CHAR> &Str );
...
DWORD WriteAnsiFile( const std::basic_string<TCHAR> &FileName, const std::basic_string<CHAR> &Str );
