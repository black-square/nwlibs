...
/*
   ...
   get_pointer_t<T>                         : Получение указателя на T
   get_const_pointer_t<T>                   : Получение константного указателя на T
...
///////////////////////////////////////////////////////////////////////////////
// Разыменование итератора. Тип после разыменования 
...
///////////////////////////////////////////////////////////////////////////////
// Разыменование указателя или итератора 
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Получение указателя на T 
///////////////////////////////////////////////////////////////////////////////
template< class T >
struct get_pointer_t: public std::unary_function< T, T * >
{
   T *operator()( T &arg ) const { return &arg; }  
};

///////////////////////////////////////////////////////////////////////////////
// Получение коснстантного указателя на T 
///////////////////////////////////////////////////////////////////////////////
template< class T >
struct get_const_pointer_t: public std::unary_function< T, const T * >
{
