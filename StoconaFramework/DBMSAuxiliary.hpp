...
{
public:
	typedef StoconaSearch::Interface::Core::DBMS::IDataTable TTable;
	typedef StoconaSearch::Interface::Core::DBMS::IDataBase TDataBase;
...
{
public:   
   typedef StoconaSearch::Interface::Core::ResourceManagers::ILingvoBaseManager TLingvoBaseManager;
   typedef StoconaSearch::Interface::Core::DBMS::IDataBase TDataBase;
