...
#ifndef StoconaAuxiliary_H
#define StoconaAuxiliary_H
...
{
   typedef StoconaSearch::Interface::IBase TIBase;
   typedef HRESULT (*CREATE_INSTANCE)(const GUID* pGuid, void** pBase);

public:
   typedef StoconaSearch::Interface::Core::ResourceManagers::ILoadManager TLoadManager;
